...
export const WallOfPhotos: FC<IWallOfPhotosProps> = ({
  ...
  if (numberOfPhotosPerQuery === undefined)
    throw new Error("No numberOfPhotosPerQuery");
    ...
    if (photos) {
      content = (
        <>
          ...
          />
          <PhotoSkeletons numberOfSkeletons={numberOfPhotosPerQuery} />
        </>
      );
    } else {
      content = <PhotoSkeletons numberOfSkeletons={numberOfPhotosPerQuery} />;
